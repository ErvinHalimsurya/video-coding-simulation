...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(500, 40, 231, 51))
        ...
        self.cCromRadio = QtWidgets.QRadioButton(self.layoutWidget2)
        self.cCromRadio.setObjectName("cCromRadio")
        self.verticalLayout_4.addWidget(self.cCromRadio)
        self.cLumradio = QtWidgets.QRadioButton(self.layoutWidget2)
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(281, 52, 125, 103))
        ...
        self.DCTRadio = QtWidgets.QRadioButton(self.layoutWidget3)
        self.DCTRadio.setObjectName("DCTRadio")
        self.verticalLayout_5.addWidget(self.DCTRadio)
        self.FFTRadio = QtWidgets.QRadioButton(self.layoutWidget3)
        self.FFTRadio.setObjectName("FFTRadio")
        self.verticalLayout_5.addWidget(self.FFTRadio)
        self.DSTradio = QtWidgets.QRadioButton(self.layoutWidget3)
        ...
        self.encodeButton.clicked.connect(MainWindow.Encode)
        self.browseButton1.clicked.connect(MainWindow.browseSourceSlot)
        self.browseButton2.clicked.connect(MainWindow.browseDestSlot)
        self.sourceInput.returnPressed.connect(MainWindow.returnSourceSlot)
        self.DestInput.returnPressed.connect(MainWindow.returnDestSlot)
        self.outputName.returnPressed.connect(MainWindow.returnNameSlot)
        self.playButton2.clicked.connect(MainWindow.playVidRes)
        self.decodedPathInput.returnPressed.connect(MainWindow.returnDecFolderSlot)
        self.browseButton3.clicked.connect(MainWindow.browseDecFolderSlot)
        self.decodedName.returnPressed.connect(MainWindow.returnDecNameSlot)
        self.decodeButton.clicked.connect(MainWindow.Decode)
        self.dispButton.clicked.connect(MainWindow.displayFile)
        self.huffButton.clicked.connect(MainWindow.displayHuff)
        self.playButton1.clicked.connect(MainWindow.playVidSource)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Kelompok 1 - Video Encoding \n"
"Made by :"))
        ...
        self.playButton1.setText(_translate("MainWindow", "Play"))
        self.playButton2.setText(_translate("MainWindow", "Play"))
        ...
        self.cCromRadio.setText(_translate("MainWindow", "Chrominance"))
